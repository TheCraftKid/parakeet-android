...
import com.thecraftkid.parakeet.ui.AssignmentDetailFragment;
...
public class AssignmentDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String classId = requireNonNull(intent.getStringExtra(EXTRA_CLASSROOM_ID));
        String assignmentId = requireNonNull(intent.getStringExtra(EXTRA_ASSIGNMENT_ID));
